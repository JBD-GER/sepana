...
export async function POST(req: Request) {
  try {
    ...
    const result = await syncEuropaceDocumentStateForCase(admin, {
      caseId,
      vorgangsnummer,
      antragsnummer,
    })
    ...
    const message = error instanceof Error ? error.message : "Europace-Unterlagen konnten nicht geladen werden."
