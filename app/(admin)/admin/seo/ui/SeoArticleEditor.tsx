...
export default function SeoArticleEditor({ dbReady, categories, topics, articles }: SeoArticleEditorProps) {
  ...
  async function handleFileChange(event: React.ChangeEvent<HTMLInputElement>) {
    ...
    if (file.size > MAX_HERO_IMAGE_SIZE_BYTES) {
      setUploadMessage("Das Bild ist zu gross. Bitte eine Datei unter 10 MB hochladen.")
              ...
              <div className="flex flex-wrap items-end justify-between gap-3">
                <div>
                  ...
                  <div className="mt-1 text-xs text-slate-500">
                    Upload in Supabase Storage `website_media` oder manuelle Pfadangabe. Maximal 10 MB pro Datei.
                  </div>
                </div>
                <button
                  type="button"
